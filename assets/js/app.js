        ...
        .then(function (data) {
            ...
            fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${getLatitude}&lon=${getLongitude}&appid=843f058e4044327330ceeb93cf7b413a&units=imperial`)
                .then(function (response) {
                    ...
                    <img src="https://openweathermap.org/img/wn/${array[0].weather[0].icon}.png" alt=""> 
                    ...
                    <p>  ${'Wind:'} ${array[0].wind.speed}</p>`;
                                dayTwo.innerHTML =
                                    ...
                                    <img src="https://openweathermap.org/img/wn/${array[1].weather[0].icon}.png" alt=""> 
                    ...
                    <p>  ${'Wind:'} ${array[1].wind.speed}</p>`;
                                dayThree.innerHTML =
                                    ...
                                    <img src="https://openweathermap.org/img/wn/${array[2].weather[0].icon}.png" alt=""> 
                    ...
                    <p>  ${'Wind:'} ${array[2].wind.speed}</p>`;
                                dayFour.innerHTML =
                                    ...
                                    <img src="https://openweathermap.org/img/wn/${array[3].weather[0].icon}.png" alt=""> 
                    ...
                    <p> ${'Wind:'} ${array[3].wind.speed}</p>`;
                                dayFive.innerHTML =
                                    ...
                                    <img src="https://openweathermap.org/img/wn/${array[4].weather[0].icon}.png" alt=""> 
